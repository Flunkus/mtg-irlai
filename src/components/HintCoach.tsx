...
// Visual styling lifted verbatim from claude-design-mockup/hint-coach.jsx.
...
export function HintCard({ hint, onDismiss, visible, fullWidth }: HintCardProps) {
      ...
      <div className="flex items-center gap-2 px-4 pt-3 pb-2">
        ...
        >
          <svg width="11" height="11" viewBox="0 0 12 12" fill="none">
            <path
              d="M6 1.5a3.5 3.5 0 0 0-2 6.4V9a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1V7.9A3.5 3.5 0 0 0 6 1.5zM5 11h2"
              stroke="currentColor"
              strokeWidth="1.2"
              strokeLinecap="round"
            />
