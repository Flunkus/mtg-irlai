...
// Visual styling lifted verbatim from claude-design-mockup/tweaks-panel.jsx.
// Modified: the iframe-host postMessage protocol from the mockup is removed;
// this app is standalone, so the panel opens/closes via explicit props instead.
